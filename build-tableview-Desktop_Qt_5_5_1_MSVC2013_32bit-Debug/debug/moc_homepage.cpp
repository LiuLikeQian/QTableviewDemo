...
QT_MOC_LITERAL(4, 28, 4) // "type"
    ...
    "HomePage\0receiveData\0\0index\0type"
};
...
static const uint qt_meta_data_HomePage[] = {
 ...
 // slots: parameters
    QMetaType::Void, QMetaType::QModelIndex, QMetaType::Int,    3,    4,
...
void HomePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->receiveData((*reinterpret_cast< const QModelIndex(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
